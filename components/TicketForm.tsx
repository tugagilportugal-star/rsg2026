        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start bg-gray-50 p-3 rounded-lg border border-gray-200">
            ...
            <label htmlFor="saConsent2" className="ml-3 text-xs text-gray-600 leading-relaxed">
              Gostava de uma assinatura gratuita de 2 anos da Scrum Alliance*! Para permitir que a Scrum Alliance me envie um convite por e-mail para ativar minha assinatura, concordo com a transferência das minhas informações pessoais pelos organizadores deste evento para a Scrum Alliance, Inc., uma organização sem fins lucrativos localizada nos Estados Unidos, e com o processamento das minhas informações pessoais pela Scrum Alliance, de acordo com a <a href="https://www.scrumalliance.org/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-brand-blue font-bold hover:underline">Política de Privacidade da Scrum Alliance</a>. *Oferta não disponível para quem já possui uma assinatura ativa da Scrum Alliance.
            </label>
          </div>
