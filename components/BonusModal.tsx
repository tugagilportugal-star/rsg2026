      ...
      <div className="bg-white rounded-[2.5rem] w-full max-w-3xl max-h-[90vh] overflow-y-auto relative shadow-2xl">
        ...
        <div className="p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="flex flex-col p-6 rounded-3xl bg-blue-50 border border-blue-100">
              ...
              <p className="text-sm text-gray-600 mb-6 flex-grow">
                Acesso ilimitado à biblioteca de E-Learning de uma das academias mais prestigiadas da Europa. Conteúdos desenhados por instrutores certificados pela <strong>Scrum Alliance</strong> e <strong>Kanban University</strong>.
              </p>
          ...
          <div className="mt-10 p-4 bg-gray-50 rounded-2xl flex items-start gap-4 border border-gray-100">
            ...
            <div>
              <h4 className="font-bold text-gray-900 text-sm">Sua privacidade em primeiro lugar</h4>
              <p className="text-xs text-gray-500 leading-relaxed">
                Os bónus são ativados diretamente por si após o evento. O RSG Lisbon não partilha os seus dados com terceiros, garantindo total controlo sobre a sua ativação e privacidade.
              </p>
            </div>
          </div>
        </div>
