    ...
    <Section id="program" className="bg-brand-darkBlue relative overflow-hidden py-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          <span className="inline-block py-1 px-3 rounded-full bg-white/10 border border-white/20 text-brand-orange font-bold tracking-[0.2em] uppercase text-[10px] mb-6">
            O foco de 2026
          </span>
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-blue-100 text-xl md:text-2xl font-medium leading-relaxed mb-4">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {dimensions.map((item) => (
            <div key={item.id} className="group relative flex flex-col h-full">
              ...
              <div className="relative flex-grow bg-white/10 border border-white/20 group-hover:border-brand-blue p-8 rounded-3xl transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-lg">
