...
<div className="mt-20 mb-12 flex flex-col items-center">
  <Link
    to="/agenda"
    className="group relative inline-flex items-center gap-6 px-12 py-6 bg-white/10 text-white hover:bg-brand-blue transition-all duration-300 rounded-2xl shadow-xl hover:-translate-y-1 border border-white/20"
  >
