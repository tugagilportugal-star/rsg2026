...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white text-brand-darkBlue py-16 border-t border-gray-200">
        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <div className="flex flex-col items-start">
                ...
                <span className="text-sm text-gray-500 font-light">Comunidade de Práticas</span>
                ...
                <div className="flex space-x-3 mt-4">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 bg-gray-100 rounded-full hover:bg-gradient-to-tr hover:from-[#f09433] hover:to-[#bc1888] hover:text-white transition-colors"
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 bg-gray-100 rounded-full hover:bg-brand-orange hover:text-white transition-colors"
          ...
          <div className="md:col-span-1">
             ...
             <ul className="space-y-3 text-gray-500">
                <li><button onClick={() => scrollTo('hero')} className="hover:text-brand-darkBlue hover:translate-x-1 transition-all">Início</button></li>
                <li><button onClick={() => scrollTo('about')} className="hover:text-brand-darkBlue hover:translate-x-1 transition-all">Sobre o Evento</button></li>
                <li><button onClick={() => scrollTo('sponsors')} className="hover:text-brand-darkBlue hover:translate-x-1 transition-all">Patrocine</button></li>
             </ul>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <a href="mailto:tuga@tugagil.com" className="flex items-center text-gray-500 hover:text-brand-darkBlue transition-colors group mb-4">
          ...
          <div className="md:col-span-1 text-sm text-gray-400">
             ...
             <div className="space-y-3">
                ...
                <p>
                    <a href="https://docs.google.com/document/d/1RQVsJYgjLgXwsFr1g-lpjxfkUTuPk0EaHCpoo9k-boo/edit?usp=sharing" target="_blank" rel="noopener noreferrer" className="hover:text-brand-darkBlue underline decoration-gray-300 underline-offset-4">Política de Privacidade</a>
                </p>
