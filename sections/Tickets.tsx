...
export const Tickets: React.FC<TicketsProps> = ({ onOpenTicketModal }) => {
  ...
  const ticketBenefits: { text: React.ReactNode; isBonus: boolean }[] =[
    ...
    { 
      text: (
        <>1 ano de <a href="https://www.agile-academy.com/pt/e-learning/#elearning-overview" target="_blank" rel="noopener noreferrer" className="underline decoration-gray-300 hover:decoration-brand-orange hover:text-brand-orange transition-colors">Agile Academy</a> (~€249)</>
      ), 
      isBonus: true 
    },
    { 
    ...
    <Section id="tickets" className="relative overflow-hidden bg-white">
      <div className="text-center mb-6 md:mb-8">
        ...
        <p className="mt-3 max-w-3xl mx-auto text-lg md:text-2xl text-gray-500 leading-relaxed">
          {showTicketBox ? 'Participe de uma das maiores celebrações da agilidade em Portugal. Preço exclusivo para os primeiros inscritos.' : 'Seja o primeiro a saber quando os bilhetes abrirem. Inscreva-se na lista de espera e garanta acesso prioritário.'}
        </p>
      </div>
          ...
          <>
            ...
            <div className="relative bg-white border-2 border-brand-orange rounded-[32px] shadow-[0_16px_40px_rgba(0,0,0,0.08)] px-7 md:px-8 py-4 md:py-5">
              ...
              <div className="text-center mb-6">
                <div className="text-4xl md:text-5xl font-black text-brand-darkBlue leading-none">{ticketPrice}</div>
              </div>
              ...
              <div className="mt-6 text-left space-y-3 border-t border-gray-100 pt-4">
                  <p className="text-[11px] text-gray-400 leading-tight"><span className="text-red-500 font-bold">*</span> Acesso à gravação disponível por +€10,00 no momento da compra.</p>
                  <p className="text-[11px] text-gray-400 leading-tight"><span className="text-gray-500 font-bold">**</span> Os bónus exclusivos (Agile Academy e Kanban+) são ativados diretamente pelo participante após o evento. <span className="font-semibold text-gray-500">Zero partilha de dados</span> da nossa parte, garantindo a sua total privacidade.</p>
                  <p className="text-[11px] text-gray-400 leading-tight text-center mt-2">Fatura com contribuinte disponível no momento da compra.</p>
              </div>
            </div>
          </>
        )}
