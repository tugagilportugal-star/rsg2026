...
export const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Badge Flutuante (Opcional - mantive pois faz parte da estrutura anterior, mas pode remover se quiser limpar mais) */}
      ...
      <div className="relative z-10 text-center px-4 max-w-7xl mx-auto flex flex-col items-center justify-center flex-grow pt-32">
        ...
        {/* LISBOA 2026 - Fonte Fina e Espaçada */}
        ...
        {/* CONTADOR (Mantido para urgência) */}
